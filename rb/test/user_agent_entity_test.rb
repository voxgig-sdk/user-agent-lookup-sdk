...
class UserAgentEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set USERAGENTLOOKUP_TEST_USER_AGENT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def user_agent_basic_setup(extra)
  ...
  entid_env_raw = ENV["USERAGENTLOOKUP_TEST_USER_AGENT_ENTID"]
