...
#      offline in seeded test mode (UserAgentLookupSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UserAgentLookup_sdk.rb")
  SDK_CLASS = "UserAgentLookupSDK"
