...
func registerSDKWords(r *eng.Registry, client *sdk.UserAgentLookupSDK) {
...
func runOp(client *sdk.UserAgentLookupSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
