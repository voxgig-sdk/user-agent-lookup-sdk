...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/user-agent-lookup` | `npm install @voxgig-sdk/user-agent-lookup` |
| Python | `voxgig-sdk-user-agent-lookup` | `pip install voxgig-sdk-user-agent-lookup` |
| PHP | `voxgig-sdk/user-agent-lookup` | `composer require voxgig-sdk/user-agent-lookup` |
| Golang | `github.com/voxgig-sdk/user-agent-lookup-sdk/go` | `go get github.com/voxgig-sdk/user-agent-lookup-sdk/go` |
| Ruby | `voxgig-sdk-user-agent-lookup` | `gem install voxgig-sdk-user-agent-lookup` |
| Lua | `voxgig-sdk-user-agent-lookup` | `luarocks install voxgig-sdk-user-agent-lookup` |
