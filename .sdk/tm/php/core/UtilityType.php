...
// UserAgentLookup SDK utility type

class UserAgentLookupUtility
{
    ...
    public static function copy(UserAgentLookupUtility $src): UserAgentLookupUtility
    {
        $u = new UserAgentLookupUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
