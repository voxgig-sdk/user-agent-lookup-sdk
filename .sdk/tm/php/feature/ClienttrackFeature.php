...
// UserAgentLookup SDK clienttrack feature
...
class UserAgentLookupClienttrackFeature extends UserAgentLookupBaseFeature
{
    ...
    public function PostConstruct(UserAgentLookupContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UserAgentLookup-SDK';
