...
// UserAgentLookup SDK netsim feature
...
class UserAgentLookupNetsimFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _simulate(UserAgentLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UserAgentLookupContext $ctx, array $applied): void
    {
        $client = $this->client;
