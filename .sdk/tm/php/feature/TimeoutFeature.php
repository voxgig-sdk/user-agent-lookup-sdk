...
// UserAgentLookup SDK timeout feature
...
class UserAgentLookupTimeoutFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _with_timeout(UserAgentLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UserAgentLookupContext $_ctx, float $ms): void
    {
        $client = $this->client;
