...
// UserAgentLookup SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class UserAgentLookupTestFeature extends UserAgentLookupBaseFeature
{
    ...
    public function init(UserAgentLookupContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (UserAgentLookupContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = UserAgentLookupParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (UserAgentLookupContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(UserAgentLookupContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = UserAgentLookupParam::call($ctx, $k);
