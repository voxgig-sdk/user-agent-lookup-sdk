...
// UserAgentLookup SDK streaming feature
...
class UserAgentLookupStreamingFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _iterate(UserAgentLookupResult $result): \Generator
    {
    ...
    private function _streamable(UserAgentLookupContext $ctx): bool
    {
