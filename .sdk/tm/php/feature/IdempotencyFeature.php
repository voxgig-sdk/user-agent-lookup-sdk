...
// UserAgentLookup SDK idempotency feature
...
class UserAgentLookupIdempotencyFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _mutating(UserAgentLookupContext $ctx): bool
    {
