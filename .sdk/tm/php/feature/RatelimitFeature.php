...
// UserAgentLookup SDK ratelimit feature
...
class UserAgentLookupRatelimitFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _acquire(UserAgentLookupContext $ctx): void
    {
    ...
    private function _track(UserAgentLookupContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
