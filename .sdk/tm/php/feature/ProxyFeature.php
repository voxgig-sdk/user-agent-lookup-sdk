...
// UserAgentLookup SDK proxy feature
...
class UserAgentLookupProxyFeature extends UserAgentLookupBaseFeature
{
    ...
    public function init(UserAgentLookupContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UserAgentLookupContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
