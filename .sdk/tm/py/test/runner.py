...
class UserAgentLookupTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UserAgentLookupTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UserAgentLookupTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UserAgentLookupTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
