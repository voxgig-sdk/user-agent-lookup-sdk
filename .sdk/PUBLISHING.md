...
|---|---|---|
| `ts/` | @voxgig-sdk/user-agent-lookup-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/user-agent-lookup-sdk \
      --repository voxgig-sdk/user-agent-lookup-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/user-agent-lookup-sdk` shows it, and
`npm trust revoke @voxgig-sdk/user-agent-lookup-sdk --id=<id>` removes it.
