...
function runner.env_override(m)
  local live = runner.getenv("USERAGENTLOOKUP_TEST_LIVE")
  local override = runner.getenv("USERAGENTLOOKUP_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("USERAGENTLOOKUP_TEST_EXPLAIN")
