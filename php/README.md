# UserAgentLookup PHP SDK



The PHP SDK for the UserAgentLookup API — an entity-oriented client using PHP conventions.
...
```
php/
├── useragentlookup_sdk.php          -- Main SDK class
...
The main class (`useragentlookup_sdk.php`) exports the SDK class
