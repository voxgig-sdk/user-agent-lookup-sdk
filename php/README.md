...
The PHP SDK for the UserAgentLookup API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->UserAgent(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->UserAgentLookup(null)->load(
    ["id" => "test01"], null
);
