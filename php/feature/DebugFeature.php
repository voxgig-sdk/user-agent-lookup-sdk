...
// UserAgentLookup SDK debug feature
...
class UserAgentLookupDebugFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _finish(UserAgentLookupContext $ctx, bool $ok): void
    {
