...
// UserAgentLookup SDK metrics feature
...
class UserAgentLookupMetricsFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _record(UserAgentLookupContext $ctx, bool $ok): void
    {
