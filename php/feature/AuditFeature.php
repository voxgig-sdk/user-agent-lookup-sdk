...
// UserAgentLookup SDK audit feature
...
class UserAgentLookupAuditFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _emit(UserAgentLookupContext $ctx, string $outcome): void
    {
