...
// UserAgentLookup SDK cache feature
...
class UserAgentLookupCacheFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _through(UserAgentLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
