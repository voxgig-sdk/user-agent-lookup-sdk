...
// UserAgentLookup SDK telemetry feature
...
class UserAgentLookupTelemetryFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _close(UserAgentLookupContext $ctx, bool $ok): void
    {
