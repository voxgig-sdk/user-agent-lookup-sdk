...
// UserAgentLookup SDK rbac feature
...
class UserAgentLookupRbacFeature extends UserAgentLookupBaseFeature
{
    ...
    private function _required(UserAgentLookupContext $ctx): ?string
    {
    ...
    private function _reject(UserAgentLookupContext $ctx, string $required): void
    {
    ...
    private function _track(UserAgentLookupContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
