...
class UserAgentLookupSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = UserAgentLookupHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = UserAgentLookupHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!UserAgentLookupFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, UserAgentLookupFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return UserAgentLookupUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = UserAgentLookupHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = UserAgentLookupHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = UserAgentLookupHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new UserAgentLookupError($op . "_allow",
                "UserAgentLookupSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = UserAgentLookupHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new UserAgentLookupError("graphql_error",
                "UserAgentLookupSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function UserAgent($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_user_agent === null) {
                $this->_user_agent = new UserAgentEntity($this, null);
            }
            return $this->_user_agent;
        }
        return new UserAgentEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new UserAgentLookupSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
