...
// UserAgentLookup SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UserAgentLookupMakeRequest
{
    public static function call(UserAgentLookupContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UserAgentLookupResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UserAgentLookupResponse($fetched);
        } else {
