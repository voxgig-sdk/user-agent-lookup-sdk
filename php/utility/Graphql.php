...
// UserAgentLookup SDK utility: graphql
//
...
class UserAgentLookupGraphql
{
    ...
    // equivalent.
    public static function body(UserAgentLookupContext $ctx): mixed
    {
    ...
    public static function errors(UserAgentLookupContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
