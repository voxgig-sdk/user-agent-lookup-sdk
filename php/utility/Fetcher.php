...
// UserAgentLookup SDK utility: fetcher

class UserAgentLookupFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UserAgentLookupSDK/1.0)';
    ...
    public static function call(UserAgentLookupContext $ctx, string $fullurl, array $fetchdef): array
    {
