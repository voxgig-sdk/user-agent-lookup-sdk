...
class UserAgentEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set USER_AGENT_LOOKUP_TEST_USER_AGENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $user_agent_ref01_data_dt0_loaded = $user_agent_ref01_ent->load($user_agent_ref01_match_dt0, null);
...
function user_agent_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("USER_AGENT_LOOKUP_TEST_USER_AGENT_ENTID");
