...
// UserAgentLookup SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UserAgentLookupSDK::test)
...
{
    private const SDK_CLASS = 'UserAgentLookupSDK';
    ...
    private const SDK_BASE = 'useragentlookup_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../useragentlookup_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
