...
// UserAgentLookup SDK pipeline test
//
...
{
    private static function utility(): UserAgentLookupUtility
    {
        return new UserAgentLookupUtility();
    }
    ...
    private static function ctx(array $over = []): UserAgentLookupContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UserAgentLookupContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UserAgentLookupOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UserAgentLookupError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UserAgentLookupOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UserAgentLookupMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UserAgentLookupOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UserAgentLookupMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UserAgentLookupOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UserAgentLookupMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UserAgentLookupSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UserAgentLookupMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UserAgentLookupResponse([]),
            'result' => new UserAgentLookupResult([]),
        ]);
        [, $err] = UserAgentLookupMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UserAgentLookupSpec([]),
            'response' => null,
            'result' => new UserAgentLookupResult([]),
        ]);
        [, $err] = UserAgentLookupMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UserAgentLookupSpec(['step' => 's']),
            'response' => new UserAgentLookupResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UserAgentLookupResult([]),
        ]);
        [, $err] = UserAgentLookupMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UserAgentLookupSpec(['step' => 's']),
            'response' => new UserAgentLookupResponse(self::resp(200, ['v' => 1])),
            'result' => new UserAgentLookupResult([]),
        ]);
        [, $err] = UserAgentLookupMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UserAgentLookupSpec(['step' => 's']),
            'response' => new UserAgentLookupResponse(self::resp(200, ['v' => 2])),
            'result' => new UserAgentLookupResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UserAgentLookupMakeResponse::call($ctx);
    ...
    {
        $preset = new UserAgentLookupResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UserAgentLookupSpec([]),
            'response' => new UserAgentLookupResponse([]),
            'result' => new UserAgentLookupResult([]),
        ...
        [$got, $err] = UserAgentLookupMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UserAgentLookupResult([])]);
        [, $err] = UserAgentLookupMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UserAgentLookupSpec([]), 'result' => null]);
        [, $err] = UserAgentLookupMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UserAgentLookupSpec(['step' => 's']),
            'result' => new UserAgentLookupResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UserAgentLookupOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UserAgentLookupMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UserAgentLookupSpec(['step' => 's']),
            'result' => new UserAgentLookupResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UserAgentLookupOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UserAgentLookupMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UserAgentLookupResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UserAgentLookupSpec([]),
            'result' => new UserAgentLookupResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UserAgentLookupMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UserAgentLookupMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UserAgentLookupError('boom', 'boom');
        $utility->fetcher = function (UserAgentLookupContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UserAgentLookupSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UserAgentLookupMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UserAgentLookupContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UserAgentLookupMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UserAgentLookupResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        UserAgentLookupMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UserAgentLookupContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UserAgentLookupSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UserAgentLookupMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UserAgentLookupResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new UserAgentLookupSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UserAgentLookupMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UserAgentLookupMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UserAgentLookupMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UserAgentLookupResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UserAgentLookupDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UserAgentLookupResult(['ok' => false])]);
        $this->expectException(UserAgentLookupError::class);
        UserAgentLookupDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UserAgentLookupResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UserAgentLookupMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UserAgentLookupMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UserAgentLookupBaseFeature();
        $b = new UserAgentLookupBaseFeature();
        UserAgentLookupFeatureAdd::call($ctx, $a);
        UserAgentLookupFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UserAgentLookupBaseFeature
    {
        $f = new UserAgentLookupBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UserAgentLookupFeatureAdd::call($ctx, self::named_feature('a'));
        UserAgentLookupFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        UserAgentLookupFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        UserAgentLookupFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        UserAgentLookupFeatureAdd::call($ctx, $replace);
        ...
        UserAgentLookupFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UserAgentLookupContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UserAgentLookupSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UserAgentLookupPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        UserAgentLookupPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UserAgentLookupResponse(['headers' => null]),
            'result' => new UserAgentLookupResult([]),
        ]);
        UserAgentLookupResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        UserAgentLookupResultBody::call($ctx);
