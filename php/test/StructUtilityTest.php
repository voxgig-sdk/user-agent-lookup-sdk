...
// UserAgentLookup SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UserAgentLookupOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UserAgentLookupOmni::structfix($now, Struct::undef()))
                        !== json_encode(UserAgentLookupOmni::structfix($val, Struct::undef()))) {
