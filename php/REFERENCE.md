# UserAgentLookup PHP SDK Reference

Complete API reference for the UserAgentLookup PHP SDK.
...
#### `UserAgentLookupSDK::test($testopts = null, $sdkopts = null)`
