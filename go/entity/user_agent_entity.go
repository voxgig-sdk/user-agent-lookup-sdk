...
type UserAgentEntity struct {
	name    string
	client  *core.UserAgentLookupSDK
...
func NewUserAgentEntity(client *core.UserAgentLookupSDK, entopts map[string]any) *UserAgentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserAgentEntity) GetName() string { return e.name }
...
func (e *UserAgentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserAgentEntity) Deleted() bool {
	return e.deleted
}


func (e *UserAgentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserAgentEntity(e.client, opts)
}

func (e *UserAgentEntity) Data(args ...any) any {
...
func (e *UserAgentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserAgent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserAgentEntity) DataTyped(data ...UserAgent) UserAgent {
	if len(data) > 0 {
		return typedFrom[UserAgent](e.Data(asMap(data[0])))
	}
	return typedFrom[UserAgent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserAgent (all fields
// optional at the wire level).
func (e *UserAgentEntity) MatchTyped(match ...UserAgent) UserAgent {
	if len(match) > 0 {
		return typedFrom[UserAgent](e.Match(asMap(match[0])))
	}
	return typedFrom[UserAgent](e.Match())
}
...
func (e *UserAgentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserAgentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserAgentLoadMatch and returns an UserAgent. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UserAgentEntity) LoadTyped(reqmatch UserAgentLoadMatch, ctrl map[string]any) (UserAgent, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UserAgent{}, err
	}
	return typedFrom[UserAgent](res), nil
}



func (e *UserAgentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UserAgentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserAgentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserAgentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserAgentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
