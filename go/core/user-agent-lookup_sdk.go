...
type UserAgentLookupSDK struct {
	Mode     string
...
func (sdk *UserAgentLookupSDK) OptionsMap() map[string]any {
...
func (sdk *UserAgentLookupSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *UserAgentLookupSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *UserAgentLookupSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UserAgentLookupSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *UserAgentLookupSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *UserAgentLookupSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("UserAgentLookupSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *UserAgentLookupSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UserAgentLookupSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("UserAgentLookupSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *UserAgentLookupSDK {
	...
	sdk := NewUserAgentLookupSDK(sdkopts)
	sdk.Mode = "test"
