...
(0, node_test_1.describe)('UserAgentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UserAgentLookupSDK({
    ...
    (0, node_test_1.test)('direct-load-user_agent', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-user_agent', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UserAgentLookupSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['USER_AGENT_LOOKUP_TEST_USER_AGENT_ENTID'];
    ...
    const client = new __1.UserAgentLookupSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=UserAgentDirect.test.js.map