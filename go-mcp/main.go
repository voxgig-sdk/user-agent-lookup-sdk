// Command UserAgentLookup-mcp is an MCP server exposing the UserAgentLookup
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UserAgentLookup_list  — list records of an entity
//	UserAgentLookup_load  — load a single record of an entity
//
