...
type Args struct {
	Entity string         `json:"entity" jsonschema:"user_agent"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UserAgentLookupSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "user-agent-lookup_list",
		Description: "List records from UserAgentLookup. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "user-agent-lookup_load",
		Description: "Load a single record from UserAgentLookup. " +
...
func runOp(client *sdk.UserAgentLookupSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UserAgentLookupSDK, name string) (sdk.UserAgentLookupEntity, error) {
	switch strings.ToLower(name) {
	case "user_agent":
		return client.UserAgent(nil), nil
