# UserAgentLookup SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UserAgentLookupSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UserAgentLookupSDK(...) and UserAgentLookupSDK.test(...) become
#      UserAgentLookupSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "useragentlookup_sdk"
_SDK_CLASS = "UserAgentLookupSDK"
