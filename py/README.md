# UserAgentLookup Python SDK



The Python SDK for the UserAgentLookup API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.UserAgent()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/user-agent-lookup-sdk/releases)) or
...
```
py/
├── useragentlookup_sdk.py         -- Main SDK module
