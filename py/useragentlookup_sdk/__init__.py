...
from useragentlookup_sdk.utility import register

# Load features
from useragentlookup_sdk.feature.base_feature import UserAgentLookupBaseFeature
from useragentlookup_sdk.features import _has_feature, _make_feature
...
class UserAgentLookupSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = UserAgentLookupUtility()
        self._utility = utility

        from useragentlookup_sdk.config import shared_config
    ...
    def get_utility(self):
        return UserAgentLookupUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UserAgentLookupSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def UserAgent(self, data=None) -> "UserAgentEntity":
        ...
        from useragentlookup_sdk.entity.user_agent_entity import UserAgentEntity
